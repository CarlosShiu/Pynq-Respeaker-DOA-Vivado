...
set_property -dict { PACKAGE_PIN W18   IOSTANDARD LVCMOS33 } [get_ports { IIC_0_0_sda_io }]; #IO_L22P_T3_34 Sch=rpio_02_r
set_property -dict { PACKAGE_PIN W19   IOSTANDARD LVCMOS33 } [get_ports { IIC_0_0_scl_io }]; #IO_L22N_T3_34 Sch=rpio_03_r
...
set_property -dict { PACKAGE_PIN C20   IOSTANDARD LVCMOS33 } [get_ports { I2S_i_0[0] }]; #IO_L1P_T0_AD0P_35 Sch=rpio_18_r
set_property -dict { PACKAGE_PIN Y8    IOSTANDARD LVCMOS33 } [get_ports { I2S_i_0[1] }]; #IO_L14N_T2_SRCC_13 Sch=rpio_19_r
set_property -dict { PACKAGE_PIN A20   IOSTANDARD LVCMOS33 } [get_ports { I2S_i_0[2] }]; #IO_L2N_T0_AD8N_35 Sch=rpio_20_r
